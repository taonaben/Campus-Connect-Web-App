				...
				<div class="row">
					<div class="col-sm-12 position-relative">
						<div class="about-img-box">
							<img src="assets/img/studentss.jpg" alt="" class="img-fluid">
						</div>
						<div class="sinse-box">
							<h3 class="sinse-title">ABOUT US
					...
					<div class="col-md-12 section-t8 position-relative">
						<div class="row">
							<div class="col-md-6 col-lg-5">
								<img src="assets/img/Studentstudying.jpg" alt="" class="img-fluid">
							</div>

							<div class="col-md-6 col-lg-5 section-md-t3">
								<div class="title-box-d">
									<h3 class="title-d">For The Students By The Students!
									</h3>
								</div>
								<p class="color-text-a">
									As university students ourselves, we have experienced first-hand challenges of
