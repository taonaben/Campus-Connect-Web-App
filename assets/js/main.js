(function () {
  ...
  const walkingDistanceLabel = document.querySelectorAll(
  ...
  document.querySelector("form").addEventListener("submit", function (e) {
    ...
    // Initialize variable to store walking distance
    let walkingDistance;

    // Loop through all sliders
    walkingDistanceSliders.forEach((slider) => {
      // Check if slider is in the form that is being submitted
      if (slider.form === this) {
        // Get the value of the slider and store it in the variable
        walkingDistance = slider.value;
      }
    });

    // Now, you can use AJAX or include this variable in your form submission to send it to your PHP script
    // For example, you can use fetch API for AJAX or set the value of a hidden input field in your form

    // For demonstration, let's set the value of a hidden input field named 'distance' in your form
